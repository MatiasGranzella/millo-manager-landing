...
const steps: { n: string; icon: LucideIcon; title: string; text: string }[] = [
  {
    ...
    icon: History,
    title: "Elegí tu era",
    text: "1986, el River de Ramón, Madrid eterno o el plantel actual. Empezá por la época que te marcó.",
  },
  {
    n: "02",
    icon: LayoutGrid,
  ...
  },
  {
    ...
    text: "Enfrentá a la comunidad en matches del día, sumá puntos y desbloqueá nuevas leyendas.",
  },
];
